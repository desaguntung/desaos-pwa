...
export default function Sidebar() {
  ...
  return (
    <aside className="h-full bg-sidebar-bg flex flex-col">
            ...
            <div key={index} className="space-y-0.5">
              {item.subMenu && item.subMenu.length > 0 ? (
                <button
                  ...
                  className={cn(
                    "flex items-center justify-between w-full text-[13px] font-medium px-3 py-2 rounded-md transition-all group",
                    isOpen || isSubActive 
                      ? "text-primary-text bg-zinc-100 dark:bg-zinc-800" 
                      : "text-secondary-text hover:text-primary-text hover:bg-zinc-50 dark:hover:bg-zinc-800"
                  )}
                >
                  <div className="flex items-center">
                    <item.icon className={cn(
                      "w-4 h-4 mr-3 transition-colors",
                      isOpen || isSubActive ? "text-primary-text" : "text-zinc-400 dark:text-zinc-500 group-hover:text-zinc-600 dark:group-hover:text-zinc-300"
                    )} />
                  ...
                  <ChevronDown
                    className={cn(
                      ...
                      isOpen ? "rotate-180 text-primary-text" : "text-zinc-400 dark:text-zinc-500"
                    )}
                  />
                </button>
              ) : (
                <Link
                  ...
                  className={cn(
                    "flex items-center justify-between w-full text-[13px] font-medium px-3 py-2 rounded-md transition-all group",
                    isActive 
                      ? "bg-zinc-100 dark:bg-zinc-800 text-primary-text" 
                      : "text-secondary-text hover:text-primary-text hover:bg-zinc-50 dark:hover:bg-zinc-800"
                  )}
                >
                  <div className="flex items-center">
                    <item.icon className={cn(
                      "w-4 h-4 mr-3 transition-colors",
                      isActive ? "text-primary-text" : "text-zinc-400 dark:text-zinc-500 group-hover:text-zinc-600 dark:group-hover:text-zinc-300"
                    )} />
                    <span>{item.label}</span>
                  </div>
                </Link>
                     ...
                     return (
                      <Link
                        ...
                        className={cn(
                          ...
                          isChildActive
                            ? "text-primary-text font-medium bg-zinc-100 dark:bg-zinc-800"
                            : "text-secondary-text hover:text-primary-text hover:bg-zinc-50 dark:hover:bg-zinc-800"
                        )}
                      >
                        {sub.label}
      ...
      <div className="p-3 border-t border-border-color bg-sidebar-bg mt-auto">
        <div className="flex items-center gap-3 px-2 py-2 mb-1 rounded-md hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors cursor-pointer">
          <div className="w-8 h-8 bg-zinc-100 dark:bg-zinc-800 rounded-full flex items-center justify-center overflow-hidden border border-border-color text-secondary-text">
          ...
          <div className="flex-1 overflow-hidden">
            ...
            <p className="text-[11px] text-secondary-text truncate capitalize">
              {loadingRole
                ? "..."
        ...
        <button
          ...
          className="flex items-center w-full text-secondary-text text-[13px] font-medium hover:text-red-600 px-2 py-2 rounded-md hover:bg-red-50 dark:hover:bg-red-900/20 transition-all"
        >
